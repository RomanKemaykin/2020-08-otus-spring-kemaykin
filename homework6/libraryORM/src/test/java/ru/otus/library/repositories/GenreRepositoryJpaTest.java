...
class GenreRepositoryJpaTest {
    ...
    void shouldReturnGenreById() {
        Genre actualGenre = genreRepositoryJpa.getById(GENRE_ONE_ID);
    ...
    void shouldReturnGenreByName() {
        Genre actualGenre = genreRepositoryJpa.getByName(GENRE_ONE_NAME);
        assertThat(actualGenre).isEqualTo(GENRE_ONE);
    }
    ...
    void shouldInsertGenre() {
        ...
        genreRepositoryJpa.save(genreForInsert);
        Genre actualGenre = genreRepositoryJpa.getById(genreForInsert.getId());
