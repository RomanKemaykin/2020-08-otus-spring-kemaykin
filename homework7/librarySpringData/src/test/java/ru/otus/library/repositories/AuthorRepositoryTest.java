...
class AuthorRepositoryTest {
    ...
    void shouldReturnAuthorById() {
       Author actualAuthor = authorRepository.getById(AUTHOR_ONE_ID);
    ...
    void shouldReturnAuthorByName() {
        Author actualAuthor = authorRepository.getByName(AUTHOR_ONE_NAME);
        assertThat(actualAuthor).isEqualTo(AUTHOR_ONE);
    }
    ...
    void shouldInsertAuthor() {
        ...
        authorRepository.save(authorForInsert);
        Author actualAuthor = authorRepository.getById(authorForInsert.getId());
